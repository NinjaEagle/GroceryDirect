...
})(exports.TypeFlags || (exports.TypeFlags = {}));
/*
...
var MapType$$1 = /** @class */ (function (_super) {
    ...
    function MapType$$1(name, subType) {
        ...
        _this.flags = exports.TypeFlags.Map;
    ...
    MapType$$1.prototype.finalizeNewInstance = function (node) {
        ...
        mobx.intercept(instance, type.willChange);
        mobx.observe(instance, type.didChange);
    };
...
var ArrayType$$1 = /** @class */ (function (_super) {
    ...
    function ArrayType$$1(name, subType) {
        var _this = _super.call(this, name) || this;
        _this.shouldAttachNode = true;
        _this.flags = exports.TypeFlags.Array;
        _this.subType = subType;
        return _this;
    }
    ...
    ArrayType$$1.prototype.createNewInstance = function (childNodes) {
        return mobx.observable.array(convertChildNodesToArray$$1(childNodes), mobxShallow);
    };
    ArrayType$$1.prototype.finalizeNewInstance = function (node) {
        var objectNode = node;
        var type = objectNode.type;
        var instance = objectNode.storedValue;
        mobx._getAdministration(instance).dehancer = objectNode.unbox;
        mobx.intercept(instance, type.willChange);
        mobx.observe(instance, type.didChange);
    };
...
var ModelType$$1 = /** @class */ (function (_super) {
    ...
    function ModelType$$1(opts) {
        ...
        _this.flags = exports.TypeFlags.Object;
        _this.shouldAttachNode = true;
    ...
    ModelType$$1.prototype._getIdentifierAttribute = function () {
        ...
        this.forAllProps(function (propName, propType) {
            if (propType.flags & exports.TypeFlags.Identifier) {
    ...
    ModelType$$1.prototype.finalizeNewInstance = function (node, childNodes) {
        ...
        var type = objNode.type;
        var instance = objNode.storedValue;
        mobx.extendObservable(instance, childNodes, EMPTY_OBJECT, mobxShallow);
...
function tryGetOptional(type) {
    ...
    if (type.flags & exports.TypeFlags.Union && type.types)
        return type.types.find(tryGetOptional);
    if (type.flags & exports.TypeFlags.Late && type.getSubType && type.getSubType(false))
        return tryGetOptional(type.subType);
    if (type.flags & exports.TypeFlags.Optional)
        return type;
    return undefined;
}
...
var string$$1 = new CoreType$$1("string", exports.TypeFlags.String, function (v) { return typeof v === "string"; });
/**
 ...
 */
// tslint:disable-next-line:variable-name
var number$$1 = new CoreType$$1("number", exports.TypeFlags.Number, function (v) { return typeof v === "number"; });
/**
 ...
 */
// tslint:disable-next-line:variable-name
var integer$$1 = new CoreType$$1("integer", exports.TypeFlags.Integer, function (v) { return isInteger(v); });
/**
 ...
 */
// tslint:disable-next-line:variable-name
var boolean$$1 = new CoreType$$1("boolean", exports.TypeFlags.Boolean, function (v) { return typeof v === "boolean"; });
/**
 ...
 * @alias types.null
 */
var nullType$$1 = new CoreType$$1("null", exports.TypeFlags.Null, function (v) { return v === null; });
/**
 ...
 */
var undefinedType$$1 = new CoreType$$1("undefined", exports.TypeFlags.Undefined, function (v) { return v === undefined; });
/**
 ...
 */
// tslint:disable-next-line:variable-name
var DatePrimitive$$1 = new CoreType$$1("Date", exports.TypeFlags.Date, function (v) { return typeof v === "number" || v instanceof Date; }, function (v) { return (v instanceof Date ? v : new Date(v)); });
...
function isPrimitiveType$$1(type) {
    return (isType$$1(type) &&
        (type.flags &
            (exports.TypeFlags.String |
                exports.TypeFlags.Number |
                exports.TypeFlags.Integer |
                exports.TypeFlags.Boolean |
                exports.TypeFlags.Date)) >
            0);
}
...
var Literal$$1 = /** @class */ (function (_super) {
    ...
    function Literal$$1(value) {
        ...
        _this.shouldAttachNode = false;
        _this.flags = exports.TypeFlags.Literal;
        _this.value = value;
        return _this;
    }
...
var Refinement$$1 = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Refinement$$1.prototype, "flags", {
        get: function () {
            return this.type.flags | exports.TypeFlags.Refinement;
        },
        enumerable: true,
        configurable: true
    });
...
var Union$$1 = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Union$$1.prototype, "flags", {
        get: function () {
            var result = exports.TypeFlags.Union;
...
var OptionalValue$$1 = /** @class */ (function (_super) {
    ...
    Object.defineProperty(OptionalValue$$1.prototype, "flags", {
        get: function () {
            return this.type.flags | exports.TypeFlags.Optional;
        },
        enumerable: true,
        configurable: true
    });
...
var Late$$1 = /** @class */ (function (_super) {
    ...
    Object.defineProperty(Late$$1.prototype, "flags", {
        get: function () {
            return (this._subType ? this._subType.flags : 0) | exports.TypeFlags.Late;
        },
        enumerable: true,
        configurable: true
    });
    ...
    Late$$1.prototype.getSubType = function (mustSucceed) {
        if (this._subType === null) {
            ...
            if (t) {
                if (process.env.NODE_ENV !== "production" && !isType$$1(t))
...
var Frozen$$1 = /** @class */ (function (_super) {
    ...
    function Frozen$$1(subType) {
        ...
        _this.subType = subType;
        _this.shouldAttachNode = false;
        _this.flags = exports.TypeFlags.Frozen;
        return _this;
    }
...
var BaseReferenceType$$1 = /** @class */ (function (_super) {
    ...
    function BaseReferenceType$$1(targetType) {
        ...
        _this.shouldAttachNode = false;
        _this.flags = exports.TypeFlags.Reference;
        return _this;
    }
...
var IdentifierType$$1 = /** @class */ (function (_super) {
    ...
    function IdentifierType$$1() {
        ...
        _this.shouldAttachNode = false;
        _this.flags = exports.TypeFlags.Identifier;
        return _this;
    }
...
exports.hasParentOfType = hasParentOfType$$1;
exports.getParentOfType = getParentOfType$$1;
