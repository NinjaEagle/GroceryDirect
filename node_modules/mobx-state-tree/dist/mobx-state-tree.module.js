...
var string$$1 = new CoreType$$1("string", TypeFlags.String, function (v) { return typeof v === "string"; });
/**
 ...
 */
// tslint:disable-next-line:variable-name
var number$$1 = new CoreType$$1("number", TypeFlags.Number, function (v) { return typeof v === "number"; });
/**
 ...
 */
// tslint:disable-next-line:variable-name
var integer$$1 = new CoreType$$1("integer", TypeFlags.Integer, function (v) { return isInteger(v); });
/**
 ...
 */
// tslint:disable-next-line:variable-name
var boolean$$1 = new CoreType$$1("boolean", TypeFlags.Boolean, function (v) { return typeof v === "boolean"; });
/**
 ...
 * @alias types.null
 */
var nullType$$1 = new CoreType$$1("null", TypeFlags.Null, function (v) { return v === null; });
/**
 ...
 */
var undefinedType$$1 = new CoreType$$1("undefined", TypeFlags.Undefined, function (v) { return v === undefined; });
/**
 ...
 */
// tslint:disable-next-line:variable-name
var DatePrimitive$$1 = new CoreType$$1("Date", TypeFlags.Date, function (v) { return typeof v === "number" || v instanceof Date; }, function (v) { return (v instanceof Date ? v : new Date(v)); });
...
export { types, typecheckPublic$$1 as typecheck, escapeJsonPath$$1 as escapeJsonPath, unescapeJsonPath$$1 as unescapeJsonPath, joinJsonPath$$1 as joinJsonPath, splitJsonPath$$1 as splitJsonPath, decorate$$1 as decorate, addMiddleware$$1 as addMiddleware, process$1$$1 as process, isStateTreeNode$$1 as isStateTreeNode, flow, applyAction$$1 as applyAction, onAction$$1 as onAction, recordActions$$1 as recordActions, createActionTrackingMiddleware, setLivelynessChecking$$1 as setLivelynessChecking, TypeFlags, getType$$1 as getType, getChildType$$1 as getChildType, onPatch$$1 as onPatch, onSnapshot$$1 as onSnapshot, applyPatch$$1 as applyPatch, recordPatches$$1 as recordPatches, protect$$1 as protect, unprotect$$1 as unprotect, isProtected$$1 as isProtected, applySnapshot$$1 as applySnapshot, getSnapshot$$1 as getSnapshot, hasParent$$1 as hasParent, getParent$$1 as getParent, hasParentOfType$$1 as hasParentOfType, getParentOfType$$1 as getParentOfType, getRoot$$1 as getRoot, getPath$$1 as getPath, getPathParts$$1 as getPathParts, isRoot$$1 as isRoot, resolvePath$$1 as resolvePath, resolveIdentifier$$1 as resolveIdentifier, getIdentifier$$1 as getIdentifier, tryResolve$$1 as tryResolve, getRelativePath$$1 as getRelativePath, clone$$1 as clone, detach$$1 as detach, destroy$$1 as destroy, isAlive$$1 as isAlive, addDisposer$$1 as addDisposer, getEnv$$1 as getEnv, walk$$1 as walk, getMembers$$1 as getMembers, cast$$1 as cast };
