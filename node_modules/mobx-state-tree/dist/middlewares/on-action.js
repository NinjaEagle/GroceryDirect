...
import { getStateTreeNode, isStateTreeNode, addMiddleware, tryResolve, applyPatch, getType, applySnapshot, isRoot, isProtected, fail, isPlainObject, isPrimitive, isArray, asArray, getRelativePathBetweenNodes } from "../internal";
 ...
 * @returns {IDisposer}
 */
export function onAction(target, listener, attachAfter) {
